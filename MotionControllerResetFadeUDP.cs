...
public class MotionControllerResetFadeUDP : MonoBehaviour {
	...
	private pythonTalkerUDP pyTalker;  //python talker script - sends start recording signal

	//start
	void Start (){
		posFad = GetComponent<positionFade> ();
		pyTalker = GetComponent<pythonTalkerUDP> ();		
	}
